...
export const post: Post = {
  rootPagePath: 'go',
  title: 'Using Interfaces in Golang',
  shortTitle: 'interfaces',

  description: "A deep dive into Go's interface mechanisms",
  tags: 'go interfaces abstraction',
  date: 'June 23, 2023',
  postId: 'go-interfaces',
  pathForDynamicLoad: 'src/posts/Go/Interfaces',
  component: '<go-interfaces></go-interfaces>',
  renderFunc: () => html`<go-interfaces></go-interfaces>`
}

@customElement('go-interfaces')
export class GoInterfaces extends LitElement {
  @property()
  ...
  protected render (): TemplateResult {
    return html`
      <div class="title">Using Interfaces in Golang</div>
